...
if ($usuarioId) {
    // Lista os estagiários do usuário logado
    $estagiarios = $estagiarioModel->listarEstagiarios($usuarioId);
} else {
    // Se não houver um usuário logado, estagiários será uma lista vazia
    $estagiarios = [];
}
                ...
                <tbody>
                    <?php foreach ($estagiarios as $estagiario): ?>
                        <tr>
                            ...
                            <td><?= htmlspecialchars($estagiario['curso'] ?? '') ?></td>
