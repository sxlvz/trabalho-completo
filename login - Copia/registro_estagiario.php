            ...
            <div class="card" style="max-width: 800px; margin: auto;">
                ...
                <div class="card-content">
                    <form action="app/Controller/CadastrarEstagiario.php" method="POST">
                        ...
                        <!-- Campo para o CPF/CNPJ -->
                        <div class="field">
                            <label class="label" for="cpf_cnpj">CPF/CNPJ:</label>
                            <div class="control">
                                <input class="input" type="text" id="cpf_cnpj" name="cpf_cnpj" maxlength="18" 
                                       pattern="\d{11,18}" title="CPF deve conter 11 ou CNPJ deve conter 14 dígitos numéricos" required>
                            </div>
                        </div>
                        ...
                        <div class="field">
                            ...
                            <div class="control">
                                <input class="input" type="tel" id="telefone" name="telefone" minlength="10" maxlength="11" 
                                       pattern="\d{10,11}" title="Telefone deve conter entre 10 e 11 dígitos numéricos, incluindo DDD" required>
                            </div>
                        </div>
                                    ...
                                    <?php if (isset($estagios) && is_array($estagios) && count($estagios) > 0) : ?>
                                        <?php foreach ($estagios as $estagio): ?>
                                            <option value="<?= htmlspecialchars($estagio['id']) ?>" 
                                                    data-inicio="<?= htmlspecialchars($estagio['data']) ?>">
