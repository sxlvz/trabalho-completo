...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['atualizar'])) {
        ...
        $stmt = $db->prepare("UPDATE estagios SET empresa = :empresa, funcionario = :funcionario, data = :data, horario = :horario, duracao = :duracao WHERE id = :id");
        ...
        $stmt->bindValue(':duracao', $duracaoMeses, PDO::PARAM_INT);
        $stmt->execute();
    ...
    <div class="container">
        ...
        <form method="post" action="">
            ...
            <div class="field">
                ...
                <div class="control">
                    <input class="input" type="number" name="duracao" value="<?= htmlspecialchars($result['duracao']) ?>" required>
                </div>
            </div>
            <div class="field">
                <div class="control">
