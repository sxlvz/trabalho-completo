                ...
                <tbody>
                    <?php foreach ($estagios as $estagio): ?>
                        <tr>
                            ...
                            <td><?= htmlspecialchars($estagio['duracao'] ?? '') ?></td>
                            <td>
                                <?php
                                    if (isset($estagio['data']) && isset($estagio['data_termino'])) {
                                        $dataInicio = new DateTime($estagio['data']);
                                        $dataTermino = new DateTime($estagio['data_termino']);
                                        $duracao = $dataInicio->diff($dataTermino)->days;
                                        echo htmlspecialchars($duracao) . " dias";
                                    } else {
                                        echo "N/A";
                                    }
                                ?>
